...
REDIS_TOOLS = redis-tools_$(REDIS_VERSION)_$(SONiC_ARCH).deb
$(REDIS_TOOLS)_SRC_PATH = $(SRC_PATH)/redis
SONIC_MAKE_DEBS += $(REDIS_TOOLS)

REDIS_SERVER = redis-server_$(REDIS_VERSION)_$(SONiC_ARCH).deb
$(eval $(call add_derived_package,$(REDIS_TOOLS),$(REDIS_SERVER)))

REDIS_SENTINEL = redis-sentinel_$(REDIS_VERSION)_$(SONiC_ARCH).deb
