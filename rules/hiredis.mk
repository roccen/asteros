...
LIBHIREDIS = libhiredis0.13_$(HIREDIS_VERSION_FULL)_$(SONiC_ARCH).deb
...
LIBHIREDIS_DEV = libhiredis-dev_$(HIREDIS_VERSION_FULL)_$(SONiC_ARCH).deb
$(eval $(call add_derived_package,$(LIBHIREDIS),$(LIBHIREDIS_DEV)))

LIBHIREDIS_DBG = libhiredis-dbg_$(HIREDIS_VERSION_FULL)_$(SONiC_ARCH).deb
